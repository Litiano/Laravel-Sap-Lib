...
/**
 * Class ILandedCostsCodes
 * GUID={1E6899F1-7A1B-460A-B134-3A82F9083C77}
 *
 ...
 * @property int|VT_USERDEFINED $AllocationBy property AllocationBy
 * @property string $LandedCostsAllocationAccount property LandedCostsAllocationAccount
 */
class ILandedCostsCodes 
{
	/**
	...
	*/
	...
	/**
	 * DISPID=13
	 * @var int|VT_USERDEFINED $AllocationBy [29] property AllocationBy
	*/
	var $AllocationBy;

	/**
	 * DISPID=14
	 * @var string $LandedCostsAllocationAccount [8] property LandedCostsAllocationAccount
	*/
	var $LandedCostsAllocationAccount;
