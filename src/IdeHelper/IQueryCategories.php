...
/**
 * Class IQueryCategories
 * GUID={78A768C9-EDA6-4798-AFC3-114DEC3DE8E5}
 *
 ...
 * @property string $Permissions property Permissions
 */
class IQueryCategories 
{
	/**
	...
	*/
	...
	/**
	 * DISPID=12
	 * @var string $Permissions [8] property Permissions
	*/
	var $Permissions;
