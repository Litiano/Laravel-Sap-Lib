...
/**
 * Class IAccountSegmentationCategories
 * GUID={2608CED7-EBD1-4F95-B41C-ECDF2CE685E4}
 *
 * @property-read mixed|VT_PTR $Browser Get browser
 * @property-read IUserFields $UserFields Get User Fields
 * @property int $SegmentID property SegmentID
 * @property string $Code property Code
 * @property string $Name property Name
 * @property string $ShortName property ShortName
 */
class IAccountSegmentationCategories 
{
	/**
	...
	*/
	...
	/**
	 * DISPID=11
	 * @var int $SegmentID [3] property SegmentID
	*/
	var $SegmentID;
	...
	*/
	...
	/**
	 * DISPID=14
	 * @var string $ShortName [8] property ShortName
	*/
	var $ShortName;
