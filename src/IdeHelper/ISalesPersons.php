...
/**
 * Class ISalesPersons
 * GUID={481D2A59-9B17-4C56-B245-04F85EA1C74E}
 *
 * @property-read mixed|VT_PTR $Browser Get browser
 * @property-read IUserFields $UserFields Get User Fields
 * @property-read int $SalesEmployeeCode property SalesEmployeeCode
 * @property string $SalesEmployeeName property SalesEmployeeName
 * @property string $Remarks property Remarks
 * @property float $CommissionForSalesEmployee property CommissionForSalesEmployee
 * @property int $CommissionGroup property CommissionGroup
...
class ISalesPersons 
{
	...
	*/
	...
	/**
	 * DISPID=10
	 * @var int $SalesEmployeeCode [3] property SalesEmployeeCode
	*/
	var $SalesEmployeeCode;

	/**
	 * DISPID=11
	 * @var string $SalesEmployeeName [8] property SalesEmployeeName
	*/
	var $SalesEmployeeName;
	...
	*/
	...
	/**
	 * DISPID=13
	 * @var float $CommissionForSalesEmployee [5] property CommissionForSalesEmployee
	*/
	var $CommissionForSalesEmployee;

	/**
	 * DISPID=14
	 * @var int $CommissionGroup [3] property CommissionGroup
	*/
	var $CommissionGroup;
