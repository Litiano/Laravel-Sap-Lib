 ...
 * GUID={BBB45A32-F446-4ED3-915B-C811BBA6C2C7}
 *
 * @property string $RelationshipDescription property RelationshipDescription
 * @property-read int $RelationshipCode property RelationshipCode
...
class IRelationships 
{
	...
	/**
	 * DISPID=1
	 * @var string $RelationshipDescription [8] property RelationshipDescription
	*/
	var $RelationshipDescription;

	/**
	 * DISPID=2
	 * @var int $RelationshipCode [3] property RelationshipCode
	*/
