...
class IStockTaking 
{
	...
	*/
	...
	/**
	 * DISPID=4
	 * @var float $Counted [5] property Counted
	*/
	var $Counted;
	...
	*/
	...
	/**
	 * DISPID=11
	 * @param string $bstrItemCode [in]
	 * @param string $bstrWhsCode [in]
	 * @return bool 
	 * method GetByKey
	 */
	function GetByKey(
		/* string [8] [in] */ $bstrItemCode,
		/* string [8] [in] */ $bstrWhsCode 
	)
	{
	}
