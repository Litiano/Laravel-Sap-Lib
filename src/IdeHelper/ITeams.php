...
/**
 * Class ITeams
 * GUID={BCA3F54F-34D2-4E1C-A700-AD1C35F0B415}
 *
 * @property-read mixed|VT_PTR $Browser Get browser
 * @property-read IUserFields $UserFields Get User Fields
 * @property-read int $TeamID property TeamID
 * @property string $TeamName property TeamName
 * @property string $Description property Description
 * @property-read mixed|VT_PTR $TeamMembers property Team members
 */
class ITeams 
{
	/**
	...
	*/
	...
	/**
	 * DISPID=11
	 * @var int $TeamID [3] property TeamID
	*/
	var $TeamID;

	/**
	 * DISPID=12
	 * @var string $TeamName [8] property TeamName
	*/
	var $TeamName;
	...
	*/
	...
	/**
	 * DISPID=15
	 * @var mixed|VT_PTR $TeamMembers [26] property Team members
	*/
	var $TeamMembers;
