...
/**
 * Class ILocalEra
 * GUID={B7A80F7E-77C0-404E-A8B3-01D0F9136DCF}
 *
 * @property-read mixed|VT_PTR $Browser Get browser
 * @property-read IUserFields $UserFields Get User Fields
 * @property-read string $EraName property EraName
 * @property-read string|VT_DATE $StartDate property StartDate
 * @property-read string $Code property Code
 */
class ILocalEra 
{
	/**
	...
	*/
	...
	/**
	 * DISPID=7
	 * @var string $EraName [8] property EraName
	*/
	var $EraName;
