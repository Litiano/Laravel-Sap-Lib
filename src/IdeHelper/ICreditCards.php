...
/**
 * Class ICreditCards
 * GUID={49593AE6-FB7B-4B31-9029-F84067559E54}
 *
 * @property-read mixed|VT_PTR $Browser Get browser
 * @property-read IUserFields $UserFields Get User Fields
 * @property-read int $CreditCardCode property CreditCardCode
 * @property string $CreditCardName property CreditCardName
 * @property string $GLAccount property GLAccount
 * @property string $Telephone property Telephone
 * @property string $CompanyID property CompanyID
...
class ICreditCards 
{
	...
	*/
	...
	/**
	 * DISPID=10
	 * @var string $CreditCardName [8] property CreditCardName
	*/
	var $CreditCardName;
	...
	*/
	...
	/**
	 * DISPID=12
	 * @var string $Telephone [8] property Telephone
	*/
	var $Telephone;

	/**
	 * DISPID=13
	 * @var string $CompanyID [8] property CompanyID
	*/
	var $CompanyID;
