...
/**
 * Class IFactoringIndicators
 * GUID={DFE5A4A8-345B-43B3-A77F-906F10F142EE}
 *
 * @property-read mixed|VT_PTR $Browser Get browser
 * @property-read IUserFields $UserFields Get User Fields
 * @property string $IndicatorCode property IndicatorCode
 * @property string $IndicatorName property IndicatorName
 */
class IFactoringIndicators 
{
	/**
	...
	*/
	...
	/**
	 * DISPID=9
	 * @var string $IndicatorCode [8] property IndicatorCode
	*/
	var $IndicatorCode;

	/**
	 * DISPID=10
	 * @var string $IndicatorName [8] property IndicatorName
	*/
	var $IndicatorName;
